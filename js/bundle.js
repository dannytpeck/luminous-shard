...
var _challenges = __webpack_require__(6);
...
var createCSV = function createCSV(employer) {
  ...
  for (var row = 0; row < (0, _jquery2.default)('#challenge-list tbody')[0].rows.length; row++) {
    ...
    data.push([(0, _jquery2.default)('#eid' + employer).val(), '', challengeType, isWeekly, winStrategy, (0, _jquery2.default)('#required' + row).val() === '0' ? '1' : (0, _jquery2.default)('#required' + row).val(), activity, '"' + (0, _jquery2.default)('#chalTitle' + row).val() + '"', '', (0, _jquery2.default)('#startDate' + row).val().replace(/-/g, '/'), (0, _jquery2.default)('#endDate' + row).val().replace(/-/g, '/'), sanitize((0, _jquery2.default)('#sd' + row).html()), sanitize((0, _jquery2.default)('#mi' + row).html()), (0, _jquery2.default)('#imgLink' + row).attr('href').replace(/https:\/\/mywellmetrics\.com/g, ''), '0', rewardType, (0, _jquery2.default)('#points' + row).val(), dimensionsARR(row) === '"undefined"' ? '' : dimensionsARR(row), '', enableDeviceTracking, allowSelfReporting, deviceTrackingUnits, isTeamChallenge, isTeamChallenge ? (0, _jquery2.default)('#teamMin' + row).val() : '', isTeamChallenge ? (0, _jquery2.default)('#teamMax' + row).val() : '', (0, _jquery2.default)('#subgroup' + row).val(), (0, _jquery2.default)('#field-one' + row).val(), (0, _jquery2.default)('#field-one-value' + row).val(), (0, _jquery2.default)('#field-two' + row).val(), (0, _jquery2.default)('#field-two-value' + row).val(), (0, _jquery2.default)('#field-three' + row).val(), (0, _jquery2.default)('#field-three-value' + row).val()]);
  }
