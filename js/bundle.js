...
/*! dynamic exports provided */
/*! all exports used */
function(t,n,e){"use strict";function r(){var t=[],n=[],e=[],r=[],i=[],o=[],u=[],c=function(t,n){var e=t.replace(/[^a-zA-Z]/g,""),r=n.replace(/[^a-zA-Z]/g,"");if(e===r){var i=parseInt(t.replace(/[^0-9]/g,""),10),o=parseInt(n.replace(/[^0-9]/g,""),10);return i===o?0:i>o?1:-1}return e>r?1:-1},f=[],b=[],w=$("#sortName").hasClass("asc")?"dec":"asc";p.map(function(t){f.push(t.innerHTML),b.push(t.innerHTML)}),$("#sortName").hasClass("asc")?f.sort(c):f.sort(c).reverse();for(var x=0;x<f.length;x++){var S=f.indexOf(b[x]);i[S]=v[x].innerHTML,u[S]=y[x].innerHTML,e[S]=h[x].innerHTML,t[S]=s[x],n[S]=l[x].innerHTML,r[S]=d[x].innerHTML,o[S]=g[x].innerHTML}$("#sortName").removeClass("asc dec").addClass(w),$("#sortCreated").removeClass("asc dec").addClass(w),$("#sortUpdated").removeClass("asc dec").addClass(w);for(var E="",O=0;O<f.length;O++)E+='<tr>\n\t\t\t\t<td><button id="'+t[O]+'" class="btn btn-default add-remove">Add</button><span class="countX">x</span><input class="countBox" type="number" value="1" /></td>\n      \t<td>'+n[O]+"</td>\n      \t<td>"+e[O]+'</td>\n      \t<td><span style="display:none">'+r[O]+"</span><span>"+i[O]+'</span></td>\n      \t<td><span style="display:none">'+o[O]+"</span><span>"+u[O]+"</span></td>\n      </tr>";$("#table-body").html(E),$(".add-remove").click(a);for(var T=0;T<m.length;T++){var A=$("#"+m[T]);A.html("Remove"),A.siblings().val(_[T])}}function i(){var t=[],n=[],e=[],r=[],i=[],o=[],u=[],c=[],f=[],p=[],v=$("#sortCreated").hasClass("asc")?"dec":"asc";d.map(function(t){var n=new Date(t.innerHTML).getTime();p.push(n),f.push(n)}),$("#sortCreated").hasClass("dec")?p.sort(function(t,n){return t-n}):p.sort(function(t,n){return n-t});for(var b=0;b<f.length;b++){var w=p.indexOf(f[b]);o[w]=new Date(f[b]).toDateString(),c[w]=y[b].innerHTML,r[w]=h[b].innerHTML,t[w]=s[b],n[w]=l[b].innerHTML,e[w]=h[b].innerHTML,u[w]=g[b].innerHTML}i=p,$("#sortName").removeClass("asc dec"),$("#sortCreated").removeClass("asc dec").addClass(v),$("#sortUpdated").removeClass("asc dec");for(var x="",S=0;S<f.length;S++)x+='<tr>\n\t\t\t\t<td><button id="'+t[S]+'" class="btn btn-default add-remove">Add</button><span class="countX">x</span><input class="countBox" type="number" value="1" /></td>\n      \t<td>'+n[S]+"</td>\n      \t<td>"+e[S]+'</td>\n      \t<td><span style="display:none">'+i[S]+"</span><span>"+o[S]+'</span></td>\n      \t<td><span style="display:none">'+u[S]+"</span><span>"+c[S]+"</span></td>\n      </tr>";$("#table-body").html(x),$(".add-remove").click(a);for(var E=0;E<m.length;E++){var O=$("#"+m[E]);O.html("Remove"),O.siblings().val(_[E])}}function o(){var t=[],n=[],e=[],r=[],i=[],o=[],u=[],c=[],f=[],p=[],y=$("#sortUpdated").hasClass("asc")?"dec":"asc";g.map(function(t){var n=new Date(t.innerHTML).getTime();p.push(n),f.push(n)}),$("#sortUpdated").hasClass("dec")?p.sort(function(t,n){return t-n}):p.sort(function(t,n){return n-t});for(var b=0;b<f.length;b++){var w=p.indexOf(f[b]);o[w]=v[b].innerHTML,c[w]=new Date(f[b]).toDateString(),r[w]=h[b].innerHTML,t[w]=s[b],n[w]=l[b].innerHTML,e[w]=h[b].innerHTML,i[w]=d[b].innerHTML}u=p,$("#sortName").removeClass("asc dec"),$("#sortCreated").removeClass("asc dec"),$("#sortUpdated").removeClass("asc dec").addClass(y);for(var x="",S=0;S<f.length;S++)x+='<tr>\n\t\t\t\t<td><button id="'+t[S]+'" class="btn btn-default add-remove">Add</button><span class="countX">x</span><input class="countBox" type="number" value="1" /></td>\n      \t<td>'+n[S]+"</td>\n      \t<td>"+e[S]+'</td>\n      \t<td><span style="display:none">'+i[S]+"</span><span>"+o[S]+'</span></td>\n      \t<td><span style="display:none">'+u[S]+"</span><span>"+c[S]+"</span></td>\n      </tr>";$("#table-body").html(x),$(".add-remove").click(a);for(var E=0;E<m.length;E++){var O=$("#"+m[E]);O.html("Remove"),O.siblings().val(_[E])}}function u(){setTimeout(function(){$("#table-body tr").toArray().map(function(t){s.push(t.cells[0].getElementsByTagName("BUTTON")[0].id),l.push(t.cells[1]),p.push(t.cells[2].getElementsByTagName("A")[0]),h.push(t.cells[2]),d.push(t.cells[3].getElementsByTagName("SPAN")[0]),v.push(t.cells[3].getElementsByTagName("SPAN")[1]),g.push(t.cells[4].getElementsByTagName("SPAN")[0]),y.push(t.cells[4].getElementsByTagName("SPAN")[1])})},500)}function a(t){var n=document.getElementById("idList"),e=t.target.parentNode.getElementsByTagName("input")[0],r=t.target.parentNode.parentNode.children[1].innerHTML,i=r+",",o=document.getElementById("pretty-list"),u=t.target.parentNode.parentNode.children[2].innerText,a="<li>"+u+"</li>";if(n.value.indexOf(r)>-1)t.target.innerHTML="Add",e.value=1,n.value=n.value.replace(new RegExp(i,"g"),""),m.splice(m.indexOf(t.target.id),1),o.innerHTML=o.innerHTML.replace(new RegExp(a,"g"),"");else{t.target.innerHTML="Remove",m.push(t.target.id),_.push(e.value);for(var c=0;c<e.value;c++)n.value+=i,o.innerHTML+=a}}function c(){var t=$(this).val();$("#table-body tr").toArray().map(function(n){if(t){var e=n.cells[1].innerText,r=n.cells[2].innerText.toLowerCase();e.indexOf(t)>-1||r.indexOf(t)>-1?n.style.display="table-row":n.style.display="none"}else n.style.display="table-row"})}function f(){$("#dateError").hide();for(var t=0;t<m.length;t++)$("#"+m[t]).html("Add");m=[],$("#file-name").val(null),$("#eid").val(null),$("#date-begin").val(null),$("#date-end").val(null),$("#idList").val(null),$("#pretty-list").html("")}Object.defineProperty(n,"__esModule",{value:!0}),n.sortName=r,n.sortCreated=i,n.sortUpdated=o,n.throwToArray=u,n.addRemove=a,n.findChallenges=c,n.resetPage=f;var s=[],l=[],p=[],h=[],d=[],v=[],g=[],y=[],m=[],_=[]},/*!*******************************************!*\
